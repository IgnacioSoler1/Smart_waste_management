...
- **ESP-IDF v5.1+** installed and configured ([install guide](https://docs.espressif.com/projects/esp-idf/en/stable/esp32/get-started/))
- **ESP32-WROOM-32** dev board (ESP32-S2/S3 not supported)
- **SIM800L** module with GSM antenna and active SIM card
- **JSN-SR04T** ultrasonic sensor (UART mode)
...
### 3. Set up JITP and generate device certificates
...
```bash
# Check the Thing was auto-created in AWS IoT Core (JITP)
...
5. On first boot, JITP creates the Thing automatically in AWS IoT Core
